...
```
dotnet user-secrets set CacheConnection "zeoRedis.redis.cache.windows.net:6380,password=HJhKU5lPmcp+pfhavegWxx7ZC+nr3Yg0c+N2UPZKwx8=,ssl=True,abortConnect=False"
```
